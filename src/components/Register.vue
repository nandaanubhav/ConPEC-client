      ...
      >
        <div v-if="!successful">
          <div class="form-group">
            ...
            <Field name="roles" type="select" class="dropdown" as="select"
              >>
              <option value="Instructor">Instructor</option>
              <option value="IndustryPractitioner">
          ...
          <div class="form-group">
            ...
            >
              ...
              <Field name="title" type="select" class="dropdown" as="select">
            ...
            <div v-else>
              ...
              <Field name="title" type="select" class="dropdown" as="select">
                ...
                <option value="ProfessorofPractice">
                  Professor of Practice
                </option>
                <option value="AssistantProfessorofPractice">
                  Assistant Professor of Practice
                </option>
                <option value="SeniorProfessorofPractice">
          ...
          <div class="form-group" v-if="values.roles === 'Instructor'">
            <label for="nameOrgIns">Name of Institution </label>
            <multiselect
          ...
          <div class="form-group" v-else>
            <label for="nameOrg">Name of Organization </label>
...
export default {
  ...
  data() {
    const schema = yup.object().shape({
      ...
      nameOrg: yup
        .string()
        .required("Name of Organization/Institution is required!"),
      confirmPassword: yup
        .string()
    ...
    const options = [
      ...
      "Hartnell College",
      "Henley-Putnam Universityhttp://henley-putnam.eduCA",
      "Harvey Mudd College",
      ...
      "Shasta College",
      "The Institute of Buddhist Studieshttp://shin-ibs.eduCA",
      "Sierra College",
      "Simpson University",
      ...
      "Stanford University",
      "Saint Mary’s Collegehttp://stmarys-ca.eduCA",
      "Taft College",
      ...
      "University of California Santa Cruz Silicon Valley Extensionhttp://ucsc-extension.eduCA",
      ...
      "Colorado State University-Pueblohttp://colostate-pueblo.eduCO",
      ...
      "Howard University",
      "Johns Hopkins School of Advanced International Studieshttp://sais-jhu.eduDC",
      ...
      "Hanover College",
      "Harrison College",
      "Holy Cross Collegehttp://hcc-nd.eduIN",
      "Indiana University",
      ...
      "Rose-Hulman Institute of Technologyhttp://rose-hulman.eduIN",
      ...
      "Kansas State Universityhttp://k-state.eduKS",
      ...
      "Suffolk University",
      "Boston Architectural Collegehttp://the-bac.eduMA",
      "Tufts University",
      ...
      "Webster University",
      "Westminster College, Missourihttp://westminster-mo.eduMO",
      ...
      "Gardner-Webb Universityhttp://gardner-webb.eduNC",
      "Gaston College",
      ...
      "Saint Augustine’s Universityhttp://st-aug.eduNC",
      ...
      "Warren Wilson Collegehttp://warren-wilson.eduNC",
      ...
      "Colby Sawyer Collegehttp://colby-sawyer.eduNH",
      "Dartmouth College",
      ...
      "Concordia College New Yorkhttp://concordia-ny.eduNY",
      "The Cooper Union",
      "Cornell University",
      "Cortland College",
      ...
      "Syracuse University",
      "Tompkins Cortland Community Collegehttp://tc3.eduNY",
      ...
      "Tiffin University",
      "Cuyahoga Community Collegehttp://tri-c.eduOH",
      ...
      "Concordia University Portland Oregonhttp://cu-portland.eduOR",
      ...
      "Butler County Community Collegehttp://bc3.eduPA",
      ...
      "Marywood University",
      "Montgomery County Community Collegehttp://mc3.eduPA",
      ...
      "University of Texas at Tylerhttp://online.uttyler.edu/TX",
  ...
  methods: {
    handleRegister(user) {
      ...
      console.log(user);
      if (user.title === "Others") user.title = user["title-text"];
      if (user.gender === "Others") user.gender = user["gender-text"];
      if (user.ethnicity === "Others") user.ethnicity = user["ethnicity-text"];
