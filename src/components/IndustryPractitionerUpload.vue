    ...
    <div class="card card-container">
      ...
      >
        <div class="form-group">
          <label>Content Type <span class="super">*</span></label>
          <select
            type="select"
            class="dropdown"
            name="contentType"
          ...
          >
            <option value="Project pictures">Project pictures</option>
            <option value="Video">Video</option>
          </select>
        </div>
        <div class="form-group">
          <label>Description <span class="super">*</span></label>
          <input
            type="text"
            name="description"
        ...
        <div class="form-group">
          <label>Content Visibility Reach<span class="super">*</span></label>
          <multiselect
...
const uploadData = (data) => {
  ...
  console.log(data);
  loading = true;
  UserService.uploadData(data).then(
    (response) => {
